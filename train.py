...
parser.add_argument('--refine_only', type=bool, default=False, help='train for refineNet only')
parser.add_argument('--main_only', type=bool, default=False, help='train for main network only')
...
if __name__ == '__main__':
    ...
    if is_distributed:
        ...
        TrainImgLoader = DataLoader(train_dataset, args.batch_size, shuffle=True, num_workers=2, drop_last=True, pin_memory=args.pin_m)
        TestImgLoader = DataLoader(test_dataset, args.batch_size, shuffle=False, num_workers=2, drop_last=False, pin_memory=args.pin_m)
