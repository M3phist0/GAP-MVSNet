...
def run(args: argparse.Namespace) -> None:
    ...
    pbar = tqdm(desc="Infer normals bld all", dynamic_ncols=True, unit="img")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--listfile", type=str, default="/root/gpufree-data/BlendedMVS/dataset_low_res/all_list.txt")
    parser.add_argument("--datapath", type=str, default="/root/gpufree-data/BlendedMVS/dataset_low_res")
