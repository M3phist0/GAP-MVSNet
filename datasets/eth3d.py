...
class MVSDataset(Dataset):
    def __init__(self, datapath, normalpath, listfile, mode, nviews, ndepths=192, interval_scale=1.06, inverse_depth=False, use_normals=True,
                 **kwargs):
        ...
        self.image_size = (1536, 1152)
        # self.image_size = (1920, 1280)
        # self.image_size = (2432, 1600)
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            depth_interval = (depth_max - depth_min) / self.ndepths
            # scale input
            img, intrinsics = self.scale_mvs_input(img, intrinsics, self.image_size[0], self.image_size[1])
            ...
            if i == 0:  # reference view
                ...
                normal = self.read_normal(normal_path, self.image_size[0], self.image_size[1])
