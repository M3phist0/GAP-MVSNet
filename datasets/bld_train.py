...
class MVSDataset(Dataset):
    def __init__(self, datapath, normalpath, listfile, mode, nviews, ndepths=192, interval_scale=1.0,
                 origin_size=False, light_idx=-1, image_scale=1.0, use_normals=True, **kwargs):
    ...
    def __getitem__(self, idx):
        ...
        len_src = len(src_views)
        new_src = src_views[:4] + src_views[len_src-4: ]
        view_ids = [ref_view] + new_src
        imgs = []
        mask = None
        depth = None
        depth_values = None
